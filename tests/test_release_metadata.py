...
EXPECTED = "0.15.0"
EXPECTED_BADGE_LINE = (
    "[![Version](https://img.shields.io/badge/v0.15.0-10B981?style=for-the-badge)]"
    "(docs/releases/v0.15.0.md)"
)
EXPECTED_TREE_LINE = (
    "├── .claude-plugin/                    "
    "← plugin.json · marketplace.json (v0.15.0 · MIT)"
)
...
class ReleaseMetadataTests(unittest.TestCase):
    ...
    def test_active_version_surfaces_match_release(self) -> None:
        ...
        self.assertIn(f"v{EXPECTED}", codex["interface"]["longDescription"])
